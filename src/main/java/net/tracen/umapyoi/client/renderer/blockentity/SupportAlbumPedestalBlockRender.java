...
public class SupportAlbumPedestalBlockRender implements BlockEntityRenderer<SupportAlbumPedestalBlockEntity> {
    ...
    private void renderAnimation(SupportAlbumPedestalBlockEntity tileEntity, float partialTicks, PoseStack poseStack,
        ...
        Minecraft.getInstance().getItemRenderer().renderStatic(item, ItemDisplayContext.FIXED, combinedLight,
                combinedOverlay, poseStack, buffer, null, (int) pPos.asLong());
    }
    ...
    private void renderItem(SupportAlbumPedestalBlockEntity tileEntity, float partialTicks, PoseStack matrixStackIn) {
        ...
        matrixStackIn.mulPose(new Quaternionf().rotateY(f));
    ...
    public void renderBook(SupportAlbumPedestalBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        pPoseStack.mulPose(new Quaternionf().rotateY(-f2));
        pPoseStack.mulPose(new Quaternionf().rotateZ(ClientUtils.convertRotation(80.0F)));
