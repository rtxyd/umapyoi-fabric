...
public class SupportCardRegistry {
    ...
    public static final RegistryObject<SupportCard> R_AGNES_TACHYON = SUPPORT_CARD.register("r_agnus_tachyon",
                    SupportCard.Builder.create()
                    .ranking(GachaRanking.R)
                    .maxDamage(10)
    ...
    public static final RegistryObject<SupportCard> SR_AGNES_TACHYON = SUPPORT_CARD.register("sr_agnus_tachyon",
                SupportCard.Builder.create()
    ...
    public static final RegistryObject<SupportCard> SSR_AGNES_TACHYON = SUPPORT_CARD.register("ssr_agnus_tachyon",
                SupportCard.Builder.create()
                .ranking(GachaRanking.SSR)
                .maxDamage(5)
                .supportType(SupportType.SPEED)
